// components/ui/combo-select-input.tsx - VERSIÓN CORREGIDA
...
const ComboSelectInput: React.FC<ComboSelectInputProps> = ({
  ...
  // ✅ CORREGIDO: Efecto con dependencias correctas
  React.useEffect(() => {
  ...
  const handleContainerClick = () => {
    if (!open) {
      setOpen(true);
      // Focus inmediato sin race condition
  ...
  return (
    <Popover.Root open={open} onOpenChange={setOpen}>
      <Popover.Anchor asChild>
        <div
          ref={anchorRef}
          onClick={handleContainerClick} // ← Usar función corregida
          className={cn(
